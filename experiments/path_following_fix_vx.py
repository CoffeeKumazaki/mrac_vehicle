...
np.savetxt("../data/output/no_init_param/adaptive_vehicle_vx_10_gain_10_theta.csv", np.array(thetas), delimiter=" ")
np.savetxt("../data/output/no_init_param/adaptive_vehicle_vx_10_gain_10_u.csv", np.array(us), delimiter=" ")
np.savetxt("../data/output/no_init_param/adaptive_vehicle_vx_10_gain_10.csv", np.array(pxs), delimiter=" ")
np.savetxt("../data/output/no_init_param/adaptive_vehicle_vx_10_gain_10_yp.csv", yps, delimiter=" ")
np.savetxt("../data/output/no_init_param/adaptive_vehicle_vx_10_gain_10_e.csv", es, delimiter=" ")
